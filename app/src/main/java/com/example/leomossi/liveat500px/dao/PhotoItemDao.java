package com.example.leomossi.liveat500px.dao;
...
public class PhotoItemDao implements Parcelable {
    ...
    @SerializedName("created_time")     private String date;
    ...
    @SerializedName("shutter_speed")    private String shutterSpreed;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(shutterSpreed);
    ...
    public String getShutterSpreed() {
        return shutterSpreed;
    }

    public void setShutterSpreed(String shutterSpreed) {
        this.shutterSpreed = shutterSpreed;
    }
